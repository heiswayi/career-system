...
$query_a = $db->query("SELECT * FROM apply_job WHERE job_id='$jv_id' AND accept_status='1'");
...
echo 'Category: <strong>Accepted Only</strong> (<a href="jval_admin.php?id='.$jv_id.'">Click here for List of All Applicants</a>)';
echo '</p>';
